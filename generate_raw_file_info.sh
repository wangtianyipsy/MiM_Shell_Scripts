...
echo "FMRI-DISTMAP_AP_0015","03_Fieldmaps/Fieldmap_imagery","DistMap_AP","fmri_fieldmap" >> ${subject}_file_information.csv
echo "FMRI-DISTMAP_PA_0011","03_Fieldmaps/Fieldmap_imagery","DistMap_PA","fmri_fieldmap" >> ${subject}_file_information.csv
echo "FMRI-DISTMAP_AP_0025","03_Fieldmaps/Fieldmap_nback","DistMap_AP","fmri_fieldmap" >> ${subject}_file_information.csv
echo "FMRI-DISTMAP_PA_0021","03_Fieldmaps/Fieldmap_nback","DistMap_PA","fmri_fieldmap" >> ${subject}_file_information.csv
...
echo "FMRI01_RUN1_0017","05_MotorImagery","fMRI_Run1","fmri" >> ${subject}_file_information.csv
echo "FMRI01_RUN2_0019","05_MotorImagery","fMRI_Run2","fmri" >> ${subject}_file_information.csv
echo "FMRI02_RUN1_0027","06_Nback","fMRI_Run1","fmri" >> ${subject}_file_information.csv
echo "FMRI02_RUN2_0029","06_Nback","fMRI_Run2","fmri" >> ${subject}_file_information.csv
echo "FMRI02_RUN3_0031","06_Nback","fMRI_Run3","fmri" >> ${subject}_file_information.csv
echo "FMRI02_RUN4_0033","06_Nback","fMRI_Run4","fmri" >> ${subject}_file_information.csv
